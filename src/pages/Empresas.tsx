  ...
  const handleExport = async (format: "csv" | "xlsx") => {
    ...
    try {
      ...
      const data = selected.map((e) => ({
        ...
        "Contato Principal": e.contato_principal_nome || "",
        "Cargo Contato": e.contato_principal_cargo || "",
        "Telefone Contato": e.contato_principal_telefone || "",
        "E-mail Contato": e.contato_principal_email || "",
        "Qtd. Contatos": e.contatos_count ?? 0,
